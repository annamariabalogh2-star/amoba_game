...
ahol az emberi játékos az `X`, a gép pedig az `O` jelet használja.  
  A játékban az `X` mindig középen kezd, utána felváltva lép az ember és a gép,  
...
Ez a projekt tanulási céllal készült, és sokat segített abban, hogy megértsem a Maven,
